...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFFFFCDD2);
  late Color tertiary = const Color(0xFFFFFFFF);
  late Color alternate = const Color(0xFFFFEBEE);
  ...
  late Color accent2 = const Color(0xFFFF1744);
  late Color accent3 = const Color(0xFFD50000);
  late Color accent4 = const Color(0xFFFF8A80);
